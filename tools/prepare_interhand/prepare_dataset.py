...
def main(argv):
    ...
    for frame_base_name in tqdm(frame_infos):
        ...
        # TODO-i: probably need convertion from meter to mm
        # tpose_joints = tpose_joints * 1000
        ...
        # import matplotlib.pyplot as plt
        #
        # vertices, joints = mano(poses_torch, betas_torch, global_t_torch)
        # v_np = vertices.detach().cpu().numpy()[0].copy()
        # x_v = v_np[:, 0]
        # y_v = v_np[:, 1]
        # z_v = v_np[:, 2]
        #
