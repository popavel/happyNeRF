...
def load_network(canonical_joints=None):
    model = create_network(canonical_joints=canonical_joints)
...
def _freeview(
    ...
    model = load_network(canonical_joints=test_loader.dataset.canonical_joints) \
