...
from third_parties.mano.manopth_hanco.manopth.load_util import ready_arguments
from third_parties.mano.manopth_hanco.manopth import rodrigues_layer, rotproj, rot6d
from third_parties.mano.manopth_hanco.manopth.tensutils import (th_posemap_axisang, th_with_zeros, subtract_flat_id)
...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        if th_betas is None or th_betas.numel() == 1:
            ...
            # TODO-q: is 1x135 in my case, why? Probably for debugging.
        ...
        # TODO-i: As of now, humanNeRF is implemented in such a way,
        #         that number if joints must correspond to the number of rotation matrices.
        #         This, obviously, excludes the possibility of using finger tips.
        #         May be it would make sense, to adjust humanNeRF implementation to be able to also use finger tips.
        # if self.side == 'right':
        ...
        # TODO-i: we do not use tips, for the moment (see previous TODO).
