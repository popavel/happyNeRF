...
# TODO-flag: Indicates which image file extension to use.
#            Can be made more generic and moved to configs later.
# EXT = '.png'
EXT = '.jpg'
...
def create_dataset(data_type='train'):
    ...
    if data_type == 'progress':
        ...
        #TODO: skip this amount of frames when picking frames from
        #       train set to progress set.
